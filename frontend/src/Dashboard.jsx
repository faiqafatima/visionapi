    ...
    <div style={styles.page}>
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <span style={styles.badge}>YOLOv8s Powered</span>
        </div>
            ...
            {history.length === 0 ? (
              <div style={styles.emptyHistory}>
                <p style={{ color: "#94a3b8", fontSize: "13px", textAlign: "center" }}>
                  No analyses yet.<br />Upload an image to get started.
                </p>
              </div>
            ) : (
...
const styles = {
  ...
  mainCol: { flex: 1, minWidth: "300px", display: "flex", flexDirection: "column", gap: "20px" },
  sideCol: { width: "300px", minWidth: "260px", display: "flex", flexDirection: "column", gap: "20px" },
